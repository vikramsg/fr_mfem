...
int main(int argc, char *argv[])
{
   ...
   VarL2_FiniteElementCollection vfec(mesh, eleOrder);
   FiniteElementSpace fes(mesh, &vfec, var_dim);
   ...
   FiniteElementSpace fes_vec(mesh, &vfec, dim*var_dim);
   ...
   FiniteElementSpace fes_op(mesh, &vfec);
