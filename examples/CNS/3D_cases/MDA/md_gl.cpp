...
const int  restart_freq      =  6100; // Create restart file after every 1000 time steps
const int  restart_cycle     = 30500; // File number used for restart
